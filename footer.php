...
<ul>
<li><a href="<?php echo $website['root'];?>game_client.php"><?php echo $Client_down['Client_down']; ?></a></li>
<li><a href="<?php echo $website['root'];?>Launcher.exe"><?php echo $Client_down3['dlq_xz']; ?></a></li>
</ul>
</div>
<div class="column">
<h3 class="account">
