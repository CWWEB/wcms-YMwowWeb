...
<div class="content-trail">
	...
	if(isset($_GET['p'])){
		...
		<li><a href="'.$website['root'].'forum" rel="np">Forums</a>
		<span class="breadcrumb-arrow"></span>
		</li>
					...
					<div class="post general">
						...
						<div class="post-edit">
							...
							<div class="talkback-controls">
								...
								<a href="javascript:;" onclick="Cms.Topic.previewToggle(this, 'edit')" class="edit-btn selected"><span class="arr"></span><span class="r"></span><span class="c"><?php echo $Forum['Forum67'];?></span></a>
							</div>
