...
<li class="last"><a href="'.$website['root'].'forum" rel="np">'.$Forums['Forums'].'</a></li>
';
}
?>
</ol>
				...
				if(isset($_SESSION['username'])){
					if($forum['locked'] == 1){
						...
						$posterInfo = mysql_fetch_assoc(mysql_query("SELECT * FROM users WHERE id = '".$account_information['id']."'"));
							switch($posterInfo['class']){
								case "blizz":
									echo'<a class="ui-button button1" href="create-topic/?f='.$forumid.'"><span><span>创建主题</span></span></a>';
									break;
								...
								default:
									echo'<a class="ui-button button1 disabled" href="#"><span><span>创建主题</span></span></a>';
									break;
							}
					}else{
						echo'<a class="ui-button button1" href="create-topic/?f='.$forumid.'"><span><span>创建主题</span></span></a>';
					...
					echo '<a class="ui-button button1 disabled"><span><span>创建主题</span></span></a>';
				}
				?>
				<span class="clear"><!-- --></span>
			</div>
