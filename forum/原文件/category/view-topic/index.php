...
if($_GET['t'] != ""){
	...
	echo '
	<li><a href="'.$website['root'].'index.php" rel="np">'.$website['title'].'</a>
	<span class="breadcrumb-arrow"></span>
	</li>
	<li><a href="'.$website['root'].'forum" rel="np">'.$Forums['Forums'].'</a>
	<span class="breadcrumb-arrow"></span>
	</li>
	<li><a href="'.$website['root'].'forum" rel="np">'.$category['name'].'</a>
	<span class="breadcrumb-arrow"></span>
	</li>
	<li><a href="'.$website['root'].'forum/category/?f='.$forum['id'].'" rel="np">'.$forum['name'].'</a>
	<span class="breadcrumb-arrow"></span>
	</li>
...
if($error == 1){
	...
	<span class="breadcrumb-arrow"></span>
	<li class="last"><a href="index.php" rel="np">'.$Forums['Forums'].'</a></li>
	';
}else{
		...
		echo
			...
			<div class="forum-actions top">
             ...
             elseif ($thread['locked'] == 1 && $userInfo['class'] == ""){
                ...
                echo '<a class="ui-button button1" href="#new-post"><span><span>'.$Forum['Forum61'].'</span></span></a>';
                if ($thread['locked'] == 0) echo '<a class="ui-button button1" href="../edit-post/lock.php?p='.$postid['id'].'"><span><span>'.$Forum['Forum80'].'</span></span></a>';
                else echo '<a class="ui-button button1" href="../edit-post/lock.php?p='.$postid['id'].'"><span><span>'.$Forum['Forum82'].'</span></span></a>';
                echo '<a class="ui-button button1" href="../edit-post/delete.php?p='.$postid['id'].'"><span><span>'.$Forum['Forum81'].'</span></span></a>';
                $categ = mysql_query("SELECT * FROM forum_categ ORDER BY num ASC");
                echo '<div style="float:right;">
                <form method="post" action="">
                <select name="t_move"><option value="">'.$Forum['Forum83'].'</option>';
                ...
                echo '</select><button type="submit" name="s_move" class="ui-button button1" style="float:right;"><span><span>'.$Forum['Forum84'].'</span></span></button>
                </form></div>';
             } 
          }
			...
			$i++;
				while($reply = mysql_fetch_array($get_replies))
				{
                    ...
                    $editorInfo = mysql_fetch_assoc(mysql_query("SELECT * FROM users WHERE id = '".$reply['editedby']."'"));						
                      ...
                      <a class="ui-button button2 " href="../edit-post/delete.php?p='.$postid['id'].'"><span><span>'.$Forum['Forum81'].'</span></span></a>							
									...
									<div class="respond">';
										if($reply['author'] == $userInfo['id']){
                      echo '<a class="ui-button button2 " href="../edit-post/?p='.$postid['id'].'"><span><span>'.$Forum['Forum22'].'</span></span></a>';
                      echo '<a class="ui-button button2 " href="../edit-post/delete.php?p='.$postid['id'].'"><span><span>'.$Forum['Forum81'].'</span></span></a>';
                    }
									  echo '
									  <a class="ui-button button2 " href="#new-post">
										  <span><span>'.$Forum['reply'].'</span></span>
						...
						<div class="post general"> 
							...
							<div class="post-edit">
								...
								<div class="talkback-controls">
									<a href="javascript:;" onclick="Cms.Topic.previewToggle(this, 'preview')" class="preview-btn"><span class="arr"></span><span class="r"></span><span class="c">预览</span></a>
									<a href="javascript:;" onclick="Cms.Topic.previewToggle(this, 'edit')" class="edit-btn selected"><span class="arr"></span><span class="r"></span><span class="c">编辑</span></a>
								</div>
