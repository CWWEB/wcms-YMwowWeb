...
0
|| checktplrefresh('./template/xinrui_wow/common/header.htm', './template/default/common/header_common.htm', 1504593590, '2', './data/template/2_2_common_header_portal_index.tpl.php', './template/xinrui_wow', 'common/header_portal_index')
|| checktplrefresh('./template/xinrui_wow/common/header.htm', './template/default/common/header_qmenu.htm', 1504593590, '2', './data/template/2_2_common_header_portal_index.tpl.php', './template/xinrui_wow', 'common/header_portal_index')
|| checktplrefresh('./template/xinrui_wow/common/header.htm', './template/xinrui_wow/common/pubsearchform.htm', 1504593590, '2', './data/template/2_2_common_header_portal_index.tpl.php', './template/xinrui_wow', 'common/header_portal_index')
;?>
