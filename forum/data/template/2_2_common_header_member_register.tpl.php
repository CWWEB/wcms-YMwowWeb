...
0
|| checktplrefresh('./template/xinrui_wow/common/header.htm', './template/default/common/header_common.htm', 1504597466, '2', './data/template/2_2_common_header_member_register.tpl.php', './template/xinrui_wow', 'common/header_member_register')
|| checktplrefresh('./template/xinrui_wow/common/header.htm', './template/default/common/header_qmenu.htm', 1504597466, '2', './data/template/2_2_common_header_member_register.tpl.php', './template/xinrui_wow', 'common/header_member_register')
|| checktplrefresh('./template/xinrui_wow/common/header.htm', './template/xinrui_wow/common/pubsearchform.htm', 1504597466, '2', './data/template/2_2_common_header_member_register.tpl.php', './template/xinrui_wow', 'common/header_member_register')
;?>
