...
0
|| checktplrefresh('./template/xinrui_wow/common/header.htm', './template/default/common/header_common.htm', 1504627573, '2', './data/template/2_2_common_header_home_spacecp.tpl.php', './template/xinrui_wow', 'common/header_home_spacecp')
|| checktplrefresh('./template/xinrui_wow/common/header.htm', './template/default/common/header_qmenu.htm', 1504627573, '2', './data/template/2_2_common_header_home_spacecp.tpl.php', './template/xinrui_wow', 'common/header_home_spacecp')
|| checktplrefresh('./template/xinrui_wow/common/header.htm', './template/xinrui_wow/common/pubsearchform.htm', 1504627573, '2', './data/template/2_2_common_header_home_spacecp.tpl.php', './template/xinrui_wow', 'common/header_home_spacecp')
;?>
