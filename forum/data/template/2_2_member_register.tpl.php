...
0
|| checktplrefresh('./template/default/member/register.htm', './template/default/common/seccheck.htm', 1504597466, '2', './data/template/2_2_member_register.tpl.php', './template/xinrui_wow', 'member/register')
