...
0
|| checktplrefresh('./template/xinrui_wow/forum/viewthread.htm', './template/default/forum/viewthread_node.htm', 1505103980, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/xinrui_wow', 'forum/viewthread')
|| checktplrefresh('./template/xinrui_wow/forum/viewthread.htm', './template/default/forum/viewthread_fastpost.htm', 1505103980, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/xinrui_wow', 'forum/viewthread')
|| checktplrefresh('./template/xinrui_wow/forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1505103980, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/xinrui_wow', 'forum/viewthread')
|| checktplrefresh('./template/xinrui_wow/forum/viewthread.htm', './template/default/common/seditor.htm', 1505103980, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/xinrui_wow', 'forum/viewthread')
|| checktplrefresh('./template/xinrui_wow/forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1505103980, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/xinrui_wow', 'forum/viewthread')
|| checktplrefresh('./template/xinrui_wow/forum/viewthread.htm', './template/default/common/upload.htm', 1505103980, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/xinrui_wow', 'forum/viewthread')
|| checktplrefresh('./template/xinrui_wow/forum/viewthread.htm', './template/default/common/seccheck.htm', 1505103980, 'diy', './data/template/2_diy_forum_viewthread.tpl.php', './template/xinrui_wow', 'forum/viewthread')
...
<div class="xr_post_floor" id="post_<?php echo $post['pid'];?>" <?php if($_G['blockedpids'] && $post['inblacklist']) { ?>style="display:none;"<?php } ?>><?php $needhiddenreply = ($hiddenreplies && $_G['uid'] != $post['authorid'] && $_G['uid'] != $_G['forum_thread']['authorid'] && !$post['first'] && !$_G['forum']['ismoderator']);
