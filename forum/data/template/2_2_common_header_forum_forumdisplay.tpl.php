...
0
|| checktplrefresh('./template/xinrui_wow/common/header.htm', './template/default/common/header_common.htm', 1504663783, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/xinrui_wow', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/xinrui_wow/common/header.htm', './template/default/common/header_qmenu.htm', 1504663783, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/xinrui_wow', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/xinrui_wow/common/header.htm', './template/xinrui_wow/common/pubsearchform.htm', 1504663783, '2', './data/template/2_2_common_header_forum_forumdisplay.tpl.php', './template/xinrui_wow', 'common/header_forum_forumdisplay')
;?>
...
<?php } } ?>
<div id="xr_page"><?php echo adshow("headerbanner/wp a_h");?><div id="hd" class="wp">
...
<?php } ?>
</li><?php if(is_array($_G['setting']['topnavs']['0'])) foreach($_G['setting']['topnavs']['0'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><li class="top_nav_li"><?php echo $nav['code'];?><?php } } ?>
<li class="top_nav_li top_nav_qmenu">
...
<li class="top_nav_li top_nav_ditnav"><?php echo $diynav;?></li>
<?php } ?>
</ul>
</div><div id="qmenu_menu" class="p_pop <?php if(!$_G['uid']) { ?>blk<?php } ?>" style="display: none;">
...
</div><div class="hdc cl"><?php $mnid = getcurrentnav();?><h2><?php if(!isset($_G['setting']['navlogos'][$mnid])) { ?><a href="<?php if($_G['setting']['domain']['app']['default']) { ?>http://<?php echo $_G['setting']['domain']['app']['default'];?>/<?php } else { ?>./<?php } ?>" title="<?php echo $_G['setting']['bbname'];?>"><?php echo $_G['style']['boardlogo'];?></a><?php } else { ?><?php echo $_G['setting']['navlogos'][$mnid];?><?php } ?></h2>
...
<div id="nv" class="cl">
<ul class="xr_nv"><?php if(is_array($_G['setting']['navs'])) foreach($_G['setting']['navs'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><li <?php if($mnid == $nav['navid']) { ?>class="a" <?php } ?><?php echo $nav['nav'];?>></li><?php } } ?>
<li class="nv_more" title="更多"></li>
</ul>
...
<div class="user_plate"><?php include template('common/header_userstatus'); ?>   
</div>
</div>
