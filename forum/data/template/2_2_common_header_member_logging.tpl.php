...
0
|| checktplrefresh('./template/xinrui_wow/common/header.htm', './template/default/common/header_common.htm', 1505202152, '2', './data/template/2_2_common_header_member_logging.tpl.php', './template/xinrui_wow', 'common/header_member_logging')
|| checktplrefresh('./template/xinrui_wow/common/header.htm', './template/default/common/header_qmenu.htm', 1505202152, '2', './data/template/2_2_common_header_member_logging.tpl.php', './template/xinrui_wow', 'common/header_member_logging')
|| checktplrefresh('./template/xinrui_wow/common/header.htm', './template/xinrui_wow/common/pubsearchform.htm', 1505202152, '2', './data/template/2_2_common_header_member_logging.tpl.php', './template/xinrui_wow', 'common/header_member_logging')
;?>
