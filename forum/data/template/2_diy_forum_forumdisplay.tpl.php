...
0
|| checktplrefresh('./template/xinrui_wow/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1504663782, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/xinrui_wow', 'forum/forumdisplay')
|| checktplrefresh('./template/xinrui_wow/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1504663782, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/xinrui_wow', 'forum/forumdisplay')
|| checktplrefresh('./template/xinrui_wow/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1504663782, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/xinrui_wow', 'forum/forumdisplay')
|| checktplrefresh('./template/xinrui_wow/forum/forumdisplay.htm', './template/xinrui_wow/forum/forumdisplay_list.htm', 1504663782, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/xinrui_wow', 'forum/forumdisplay')
|| checktplrefresh('./template/xinrui_wow/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1504663782, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/xinrui_wow', 'forum/forumdisplay')
|| checktplrefresh('./template/xinrui_wow/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1504663782, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/xinrui_wow', 'forum/forumdisplay')
|| checktplrefresh('./template/xinrui_wow/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1504663782, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/xinrui_wow', 'forum/forumdisplay')
...
<div class="boardnav">
<div id="ct" class="wp xr_list cl"<?php if($leftside) { ?> style="margin-left:<?php echo $_G['leftsidewidth_mwidth'];?>px"<?php } ?>>
<?php if($leftside) { ?>
...
<div class="desc cl">
<p class="time">
<a class="y" href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" c="1"> <?php echo $thread['author'];?> </a>
