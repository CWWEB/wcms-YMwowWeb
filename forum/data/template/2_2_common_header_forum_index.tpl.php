...
0
|| checktplrefresh('./template/xinrui_wow/common/header.htm', './template/default/common/header_common.htm', 1504592221, '2', './data/template/2_2_common_header_forum_index.tpl.php', './template/xinrui_wow', 'common/header_forum_index')
|| checktplrefresh('./template/xinrui_wow/common/header.htm', './template/default/common/header_qmenu.htm', 1504592221, '2', './data/template/2_2_common_header_forum_index.tpl.php', './template/xinrui_wow', 'common/header_forum_index')
|| checktplrefresh('./template/xinrui_wow/common/header.htm', './template/xinrui_wow/common/pubsearchform.htm', 1504592221, '2', './data/template/2_2_common_header_forum_index.tpl.php', './template/xinrui_wow', 'common/header_forum_index')
;?>
