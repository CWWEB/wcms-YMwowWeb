...
0
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/header.htm', 1505106881, '2', './data/template/2_2_search_portal.tpl.php', './template/xinrui_wow', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/pubsearch.htm', 1505106881, '2', './data/template/2_2_search_portal.tpl.php', './template/xinrui_wow', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/portal_list.htm', 1505106881, '2', './data/template/2_2_search_portal.tpl.php', './template/xinrui_wow', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/search/footer.htm', 1505106881, '2', './data/template/2_2_search_portal.tpl.php', './template/xinrui_wow', 'search/portal')
|| checktplrefresh('./template/default/search/portal.htm', './template/default/common/header_common.htm', 1505106881, '2', './data/template/2_2_search_portal.tpl.php', './template/xinrui_wow', 'search/portal')
;?>
