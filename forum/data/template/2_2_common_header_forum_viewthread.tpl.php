...
0
|| checktplrefresh('./template/xinrui_wow/common/header.htm', './template/default/common/header_common.htm', 1505103980, '2', './data/template/2_2_common_header_forum_viewthread.tpl.php', './template/xinrui_wow', 'common/header_forum_viewthread')
|| checktplrefresh('./template/xinrui_wow/common/header.htm', './template/default/common/header_qmenu.htm', 1505103980, '2', './data/template/2_2_common_header_forum_viewthread.tpl.php', './template/xinrui_wow', 'common/header_forum_viewthread')
|| checktplrefresh('./template/xinrui_wow/common/header.htm', './template/xinrui_wow/common/pubsearchform.htm', 1505103980, '2', './data/template/2_2_common_header_forum_viewthread.tpl.php', './template/xinrui_wow', 'common/header_forum_viewthread')
;?>
