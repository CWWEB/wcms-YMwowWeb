<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('discuz');?><?php include template('common/header'); ?><script src="template/xinrui_wow/js/jquery.SuperSlide.js" type="text/javascript" type="text/javascript"></script>
...
<div class="ct_inner cl">
<!--[diy=diy_chart]--><div id="diy_chart" class="area"></div><!--[/diy]-->
<?php if(!empty($_G['setting']['grid']['showgrid'])) { ?>
<!-- index four grid -->
<div id="category_grid" class="xr_grid" >
<table cellspacing="0" cellpadding="0"><tr>
<?php if(!$_G['setting']['grid']['gridtype']) { ?>
<td valign="top" class="category_l1">
<div class="newimgbox">
<div class="module cl slidebox_grid" style="width:235px">
<script type="text/javascript">
var slideSpeed = 5000;
var slideImgsize = [235,260];
...
<?php if(!empty($collectiondata['follows'])) { $forumscount = count($collectiondata['follows']);?><?php $forumcolumns = 4;?><?php $forumcolwidth = (floor(100 / $forumcolumns) - 0.1).'%';?><div class="xr_forum_box <?php if($forumcolumns) { ?> flg<?php } ?> cl">
<div class="xr_forum_tit cl">
<span class="o z">
...
<h2 class="z"><a href="forum.php?mod=collection&amp;op=my">我订阅的专辑</a></h2>
</div>
...
<?php } if(empty($gid) && !empty($forum_favlist)) { $forumscount = count($forum_favlist);?><?php $forumcolumns = $forumscount > 3 ? ($forumscount == 4 ? 4 : 5) : 1;?><?php $forumcolwidth = (floor(100 / $forumcolumns) - 0.1).'%';?><div class="xr_forum_box <?php if($forumcolumns) { ?> flg<?php } ?> cl">
<div class="xr_forum_tit cl">
<span class="o z">
...
<h2 class="z"><a href="home.php?mod=space&amp;do=favorite&amp;type=forum">我收藏的版块</a></h2>
</div>
<div id="category_0" class="single_forum" style="<?php echo $collapse['category_0']; ?>">
<table cellspacing="0" cellpadding="0" class="fl_tb">
...
<div class="xr_forum_box <?php if($cat['forumcolumns']) { ?> flg<?php } ?> cl">
<div class="xr_forum_tit cl">
<span class="o z">
...
<h2 class="z"><a href="<?php if(!empty($caturl)) { ?><?php echo $caturl;?><?php } else { ?>forum.php?gid=<?php echo $cat['fid'];?><?php } ?>" style="<?php if($cat['extra']['namecolor']) { ?>color: <?php echo $cat['extra']['namecolor'];?>;<?php } ?>"><?php echo $cat['name'];?></a></h2>
<?php if($cat['moderators']) { ?><span class="y">分区版主: <?php echo $cat['moderators'];?></span><?php } $caturl = !empty($cat['domain']) && !empty($_G['setting']['domain']['root']['forum']) ? 'http://'.$cat['domain'].'.'.$_G['setting']['domain']['root']['forum'] : '';?></div>
...
</div><?php echo adshow("intercat/bm a_c/$cat[fid]");?><?php } if(!empty($collectiondata['data'])) { $forumscount = count($collectiondata['data']);?><?php $forumcolumns = 4;?><?php $forumcolwidth = (floor(100 / $forumcolumns) - 0.1).'%';?><div class="xr_forum_box <?php if($forumcolumns) { ?> flg<?php } ?> cl">
<div class="xr_forum_tit cl">
<span class="o z">
...
<h2 class="z"><a href="forum.php?mod=collection">淘专辑推荐</a></h2>
</div>
...
<dt class="ptm pbm"><?php echo $_G['cache']['onlinelist']['legend'];?></dt>
<?php if($detailstatus) { ?>
<dd class="ptm pbm">
<ul class="cl">
