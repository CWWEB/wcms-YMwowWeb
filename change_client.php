...
<head>
<title><?php echo $website['title']; ?> - <?php echo $Man['Man1']; ?></title>
...
<div id="content">
<div id="page-header">
<h2 class="subcategory"><?php echo $ha['ha26']; ?><?php $ha['ha1']; ?></h2>
<h3 class="headline"> <?php echo $Log['Log20']; ?> </h3>
</div>
...
if (isset($_POST['change'])){ 
  ...
  if ($query == true)
  {
    ...
    echo '<div class="alert-page-message success-page">
		<p class="caption"><strong><font color="green">您的账号已成功修改资料片!</font></strong></p>
		<p class="caption">这个过程大约需要几分钟.</p>
		</div>';
  }
  else{
    echo '<div class="errors" align="center"><font color="red">与数据库连接失败!</font><br><br />';
    echo '<div class="errors" align="center">请稍后再试，或者与管理员联系.<br><br />';
  }
  ...
  if (!isset($_GET['client']) || ($expansion<>'0' && $expansion<>'1' && $expansion<>'2' && $expansion<>'3')){
    $error = true;
    echo '<p><font color="red">对不起，您必须选择一个有效的资料片进行修改.</font></p>';
  }
  else{
    echo '<p>如果确认将您的账户更改为其他的资料片，或许会有一些对其他资料片的限制.<br>这个过程大约需要几分钟.</p> 
    <p>请确认你想更改的资料片信息.</p>';
    switch ($expansion){
      case 0: 
        $name = '经典旧世'; 
  ...
  if (!$error){
    ...
    <form method="post" action="">
      ...
      <span><span>账户更改为 '.$name.' 资料片</span></span>
      </button>
      </fieldset>  
    </form>';}
  }
