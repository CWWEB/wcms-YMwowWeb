    ...
    <div id="content">
      <div class="forms">
        ...
        <table width="100%" class="table-content">
          <tr>
            <td width="50%"><p><strong>锁定: </strong>
            <style>
            div.checker{
              margin-top: -5px;
            }
            </style>
            <input type="checkbox" name="f_locked" onchange="if(this.checked){document.getElementById('is_lock').innerHTML = '<font color=red>锁定</font>';}else{document.getElementById('is_lock').innerHTML = '<font color=green>解锁</font>';}"/>
            <span id="is_lock"><font color=green>解锁</font></span></p>
            </td>
            <td>
              <p>
                <strong>归属: </strong>
          ...
          <tr><td>
          <div class="folder">
          <p><strong>图标: </strong><a href="javascript:;" onclick="pop('open');">
          ...
          <td></td></tr>
          <tr><td><p><strong>名称: </strong>
          <input type="text" name="f_name" value="输入名称" class="reg" onfocus="document.getElementById('error_name').innerHTML='';if(this.value=='输入名称')this.value=''" onblur="if(this.value=='')this.value='输入名称'"/></p></td>
          <td><div id="error_name"></div></td></tr>
          <tr><td><p><strong>描述: </strong><br />
          ...
          <tr><td align="center"><p><button type="submit" name="save">保存</button>
          <a href="forums.php?id=<?php echo $categ['id']; ?>"><button type="reset" name="cancel">取消</button></a></p></td>
          <td></td></tr>
        </table>
        </form></div>
    </div>
