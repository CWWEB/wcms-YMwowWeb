      ...
      ?> 
        <h2>
          <form method="post" action="" class="pagination">
            ...
            <button type="submit" name="change_name" value="Submit Name">提交</button>
          </form>
        </h2>
        <div style="float:right;margin: 30px 20px 0 0px;"><a href="fnew.php?id=<?php echo intval($_GET['id']); ?>"><button type="submit" name="f_new" value="New Forum">添加子版块</button></a></div>
      </div>
      <div id="moveTable">
      <table>
        <thead>
        <tr>  
          <th class="edit"><strong>编辑</strong></th>
          <th></th>   
          <th class="title"><strong>名称</strong></th>
          <th class="desc"><strong>描述</strong></th>
          <th class="inc"><strong>话题</strong></th>
          <th class="inc"><strong>锁定/解锁</strong></th>
