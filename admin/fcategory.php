...
<body class="bgc">
    ...
    <div id="content">
        ...
        <form method="post" action="" class="pagination">
          <input type="text" class="pag" name="new_categ" value="新版块" style="margin: 20px 0 0 29px;width:auto;height:auto;background-color:#FFF;font-size:18px;" onfocus="if(this.value=='New Category'){this.value=''}" onblur="if(this.value==''){this.value='New Category'}"/>
          <button type="submit" name="s_new" value="Add">增加版块</button>
        </form>
      </div><div id="moveTable">
      <table>
        <thead>
        <tr>   
          <th class="edit"><strong>管理</strong></th> 
          <th class="edit"><strong>删除</strong></th>   
          <th class="title"><strong>名称</strong></th>
          <th class="desc"><strong>子版块</strong></th>
          <th class="inc"><strong>下属版块</strong></th>
          <th class="inc"><strong>上升 / 下降</strong></th>
        </tr>
        </thead>
        <tbody>
      <?php
