...
<body class="bgc">
    ...
    <div id="content">
              <div class="datalist">
        <div class="heading">
                  <h2>最新的 <span rel="tooltip" title="<strong style='color:red'>Forum Posts</strong><br/><br/>Here you can see the latest 4 Posts of the Forum<br />Click on the <strong>Forum</strong> to redirect on the main page of the Forum Posts." style="color:#ff9200;font-weight:bold;font-size:14px;"><a href="forumposts.php">论坛</a></span> 帖子</h2>
                  <select name="sort">
            <option>排序</option>
            <option>顺序</option>
            <option>倒序</option>
        ...
        <ul id="lst">
			...
			<p class="editHead"><strong>编辑/删除</strong></p>
            <p class="title"><strong>标题</strong></p>
            <p class="descripHead">内容</p>
            <p class="incHead">回复</p>
          </li>
            ...
            <p class="inc">'.$fcheck['replies'].'</p>
				...
				<div class="datalist">
	   <div class="heading">
                  <h2>最新的 <span rel="tooltip" title="<strong style='color:red'>News Posts</strong><br/><br/>Here you can see the latest 4 Posts of the News<br />Click on the <strong>News</strong> to redirect on the main page of the News Posts." style="color:#ff9200;font-weight:bold;font-size:14px;"><a href="viewnews.php">新闻</a></span> 文章</h2>
                  <select name="sort">
            <option>排序</option>
            <option>顺序</option>
            <option>倒序</option>
      ...
      <div class="chk"><a id="checkall"></a> </div>
           ...
           <?php
			...
			<div class="datalist">
	      <div class="heading">
          <h2>最新的 <span rel="tooltip" title="<strong style='color:red'>Users Registered</strong><br/><br/>Here you can see the latest 5 Users that rigistered lately.<br />Click on the <strong>Users</strong> to redirect on the main page of the Registered Users." style="color:#ff9200;font-weight:bold;font-size:14px;"><a href="viewnews.php">用户</a></span> 注册</h2>
          <select name="sort">
            <option>排序</option>
            <option>顺序</option>
            <option>倒序</option>
        ...
        <ul id="lst">
          <li><div class="chk"><a id="checkall"></a> </div>
			      <p class="editHead"><strong>账号</strong></p>
            <p class="title"><strong>姓氏</strong></p>
            <p class="descripHead">角色</p>
            <p class="incHead">生日</p>
          </li>
		   <?php
          mysql_select_db($server_db) or die (mysql_error());
