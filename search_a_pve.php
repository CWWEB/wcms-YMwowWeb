            	...
            	if (!$error){
            	 echo '<ul class="dynamic-menu" id="menu-search">
	              ...
	              if ($num_guild>0){ echo '<li><a href="search_g_pve.php?search='.$term.'"><span class="arrow">'.$guild['Guilds'].' ('.$num_guild.')'.'<span></span></span></a></li>';}
               	if ($num_arena>0){ echo '<li class="item-active"><a href="search_a_pve.php?search='.$term.'"><span class="arrow">'.$arena['Teams'].' ('.$num_arena.')'.'<span></span></span></a></li>';}
	...
	<!-- Here goes the pagination code. -->
              <div class="data-options ">
              	<div class="option">
                	...
                	<?php
                	if (!$error){
                  pagination($page,$num_pages,$term,'search_a_pve.php',$ChatB['ChatB5'],$search['prev']);}
                  ?>
                	</ul>
               	</div>
              	<?php 
