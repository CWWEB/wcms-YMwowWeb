			...
			<div class="contents-wrapper">
				<div class="left-col" align="left">
					...
					*/
					...
					<a href="search_pve.php" class="main-services-banner left-bnr" style="background-image:url('wow/static/images/services/thumbnails/thumb-main-services-3.jpg');">
					...
					<a href="game_client.php" class="main-services-banner right-bnr" style="background-image:url('wow/static/images/services/thumbnails/thumb-main-services-6.jpg');">
