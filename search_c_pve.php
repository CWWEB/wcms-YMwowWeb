      ...
      <div class="content-top">
      	<div class="content-trail">
        	<ol class="ui-breadcrumb">
          	...
          	<li class="last">
            	<a href="search_pve.php" rel="np"><?php echo $Ind['Ind2']; ?></a>
          	</li>
        	</ol>
      	</div>
      	<div class="content-bot">
        	<div class="search">
          	<div class="search-left">
            	...
            	if (!$error){
            	 echo '<ul class="dynamic-menu" id="menu-search">
              	<li class=""><a href="search_pve.php?search='.$term.'"><span class="arrow">'.$search['summ'].'</span></a></li>';
              	if ($num_char>0){ echo '<li class="item-active"><a href="search_c_pve.php?search='.$term.'"><span class="arrow">'.$status['chars'].' ('.$num_char.')'.'<span></span></span></a></li>';}
          	...
          	<div class="search-right">
            	<div class="search-header">
              	<form action="<?php echo 'search_pve.php?search='.$term ?>" method="get" class="search-form">
              	<div>
	...
	<!-- Here goes the pagination code. -->
              <div class="data-options ">
              	<div class="option">
                	...
                	<?php
                	if (!$error){
                  pagination($page,$num_pages,$term,'search_c_pve.php',$ChatB['ChatB5'],$search['prev']);}
                  ?>
                	</ul>
               	</div>
              	<?php 
                   ...
                   if ($num_char>0){
                    echo '<tbody>';
                      while ($row = mysql_fetch_array($result)) {        //Echo list of characters
                        echo '<tr class="row1">
                        	<td><a href="" class="item-link color-c9"><span class="icon-frame frame-18"><img src="images/postavatar.jpg" alt="" width="18" height="18" /></span><strong><a href="advanced_pve.php?name='.$row["name"].'">'.$row["name"].'</a></strong></a></td>
