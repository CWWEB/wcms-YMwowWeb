...
<li><a href="<?php echo $website['root']; ?>search.php"><?php echo $ha['ha10']; ?></a></li>
<li><a href="<?php echo $website['root']; ?>search_pve.php"><?php echo $ha['ha11']; ?></a></li>
<li><a href="<?php echo $website['root']; ?>status.php"><?php echo $ha['ha12']; ?></a></li>
<li><a href="<?php echo $website['root']; ?>game_client.php"><?php echo $ha['ha13']; ?></a></li>
<li><a href="<?php echo $website['root']; ?>online.php?realm=2"><?php echo $ha['ha14']; ?></a></li>
<li><a href="<?php echo $website['root']; ?>online.php?realm=2"><?php echo $ha['ha15']; ?></a></li>
</ul>
</div>
</li>
