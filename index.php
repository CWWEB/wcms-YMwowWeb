...
<HTML>
<head>
	<title><?php echo $website['title']; ?>——<?php echo $website['slogan']; ?></title>
			...
			<div class="content-bot">	
              ...
              ?>
						...
						<div id="news-updates">
							...
							while($counter<=8 && $news=mysql_fetch_array($news_query)){
								if($counter == 1){
								...
								echo'
									...
									<div class="article-right">
										...
										<p>'. substr(strip_tags($news['content']),0,402)."……".'</p>'; //Needed striptags for not closed tags
