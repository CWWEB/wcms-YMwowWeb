			...
			<li class="last children"><a href="media.php" rel="np"><?php echo $Media['Media']; ?></a>
						...
						<div id="media-index">
							<div class="media-index-section float-left">
								...
								?>
									...
									<span class="date-added"><?php echo $Vote['Vote12']; ?>: <?php echo date('d/m/Y', strtotime($video1['date'])); ?></span>
									</span>
							...
							<div class="media-index-section float-right">
								...
								<span class="view-all"><span class="arrow"></span><?php echo $View_all['View_all']; ?></span>
								<?php
                  $screen_all = mysql_query("SELECT * FROM media WHERE visible = '1' AND type = '2'");
                  $screen_total = mysql_num_rows($screen_all);
                ?>
								<span class="gallery-icon"></span>
								<?php echo $Community['FanArt']; ?> <span class="total">(<?php echo $screen_total; ?>)</span>
								</a>
                ...
                ?>
                    ...
                    href="media/images_visor.php?type=2&id=<?php echo $screen['id']; ?>#/<?php echo $screen['id']; ?>">
									...
									<span class="date-added"><?php echo $Vote['Vote12']; ?>: <?php echo date('d/m/Y', strtotime($screen['date'])); ?></span>
									</a>
								<?php } ?>
									<span class="clear"><!-- --></span>
								</div>
                ...
                ?>
                  ...
                  href="media/images_visor.php?type=3&id=<?php echo $art['id']; ?>#/<?php echo $art['id']; ?>">
									...
									<span class="date-added"><?php echo $Vote['Vote12']; ?>: <?php echo date('d/m/Y', strtotime($art['date'])); ?></span>
									</a>
								<?php } ?>
									<span class="clear"><!-- --></span>
								</div>
              ...
              ?>
                ...
                ?>
                  ...
                  href="media/images_visor.php?type=1&id=<?php echo $wall['id']; ?>#/<?php echo $wall['id']; ?>">
									...
									<span class="date-added"><?php echo $Vote['Vote12']; ?>: <?php echo date('d/m/Y', strtotime($wall['date'])); ?></span>
									</a>
								<?php } ?>
									<span class="clear"><!-- --></span>
								</div>
