                ...
                <table width="300">
            	    <tr>
                        ...
                        <td width="79" align="left">
                            <?php
                    	 	if (!$world) echo"<font color=red size=2>离线</font><img src=\"./wow/static/images/icons/down.png\">"; 
                    	 	else echo "<font color=#00FF00 size=2>在线</font><img src=\"./wow/static/images/icons/up.png\">";
                    	  	?>
                        </td>
                    </tr>
                </table>
