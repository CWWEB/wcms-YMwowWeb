					...
					<div class="outside-section social-media">
						...
						<div class="content-block">
							...
							<style type="text/css">#wow { background: url("wow/static/images/community/001.png") no-repeat; }</style>
								<li><a href="<?php echo $comun_link['Facebook']; ?>" class="facebook" target="_blank"><span class="content-title"><?php echo $website['title']; ?> 新浪微博</span><span class="content-desc"><?php echo $Community['comm10']; ?></span></a></li>
								<li><a href="<?php echo $comun_link['Twitter']; ?>" class="twitter" target="_blank"><span class="content-title"><?php echo $website['title']; ?> 腾讯微博</span><span class="content-desc"><?php echo $Community['comm11']; ?></span></a></li>
								<li><a href="<?php echo $comun_link['Youtube']; ?>" class="youtube" target="_blank"><span class="content-title"><?php echo $website['title']; ?> 微信公众号</span><span class="content-desc"><?php echo $Community['comm12']; ?></span></a></li>
						...
						<div class="content-block">
							<ul>
							<style type="text/css">#wow { background: url("wow/static/images/community/001.png") no-repeat; }</style>
							<li><a href="http://wow.blizzard.cn" id="wow" target="_blank"><span class="content-title">魔兽世界官网</span><span class="content-desc"><?php echo $Community['comm14']; ?></span></a></li></ul>
							<ul>
							<style type="text/css">#wow { background: url("wow/static/images/community/001.png") no-repeat; }</style>
							<li><a href="http://www.ymisc.com" id="wow" target="_blank"><span class="content-title">衣米商城</span><span class="content-desc"><?php echo $Community['comm14']; ?></span></a></li></ul>
