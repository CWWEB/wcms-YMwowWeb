          ...
          function valid_email($email) {         //Small function to validate the email
              ...
              $ip = getenv("REMOTE_ADDR");
                ...
                if ($accinfo == 0)
                {
                    ...
                    $register_logon = mysql_query("INSERT INTO account (username,sha_pass_hash,email,last_ip,gmlevel,expansion) VALUES (UPPER('".$accountName."'),  CONCAT('".$sha_pass_hash."'),'".$accountEmail."','".$ip."','0','0')")or die(mysql_error());
...
<option value="CHINA" selected="selected">中国大陆</option>
...
<select name="dobDay" id="dobDay" class="extra-extra-extra-small border-5 glow-shadow-2" tabindex="1" required >
...
<select name="dobMonth" id="dobMonth" class="extra-extra-small border-5 glow-shadow-2" tabindex="1" required>
...
<span class="input-select input-select-extra-extra-extra-small">
<select name="dobYear" id="dobYear" class="extra-extra-extra-small border-5 glow-shadow-2" tabindex="1" required>
...
<span class="input-right">
<span class="input-select input-select-small">
<select name="gender" id="gender" class="small border-5 glow-shadow-2" tabindex="1" required>
...
<span class="input-right">
<span class="input-select input-select-small">
<select name="question1" id="question1" class="small border-5 glow-shadow-2" tabindex="1" required>
...
<?php
                 ...
                 echo '<div class="alert error closeable border-4 glow-shadow">
						...
						<p class="title"><strong>'.$Serv['Serv34'].'！</strong></p>
						<p class="error.password.mustMatch">'.$Log['Log10'].'.</p>
						</div>
						</div>
						<a class="alert-close" href="#" onclick="$(this).parent().fadeOut(250, function() { $(this).css({opacity:0}).animate({height: 0}, 100, function() { $(this).remove(); }); }); return false;">'.$Reg['Reg36'].'</a>
						<span class="clear"><!-- --></span>
						</div>';
