				...
				<div class="content-bot">	
					...
					<div id="blog-wrapper">
                        ...
                        $replyTo = 0;
											...
											echo '<center><br /><br />'.$Forum['Forum4'].'<br />';
											echo '
											<style type="text/css">
											.loader {
											  width:24px;
										...
										<div class="byline">
											<div class="blog-info">
											'.$Forum['Forum49'].' <a href="#">'.$posterInfo['firstName'].'</a><span>//</span> '.$news['date'].'
											</div>
...
<h3>What抯 Your Level of Secondary Profession Expertise?</h3>
...
<tr>
<td>I抳e leveled three or four of the secondary professions to their maximum, and use them regularly.</td>
<td>
...
<tr>
<td>My main focus among the secondary professions is archaeology. I抦 unearthing most of Azeroth.</td>
<td>
<div class="result-container ">
...
<tr>
<td>Just fishing. I抦 the master angler around here!</td>
<td>
<div class="result-container ">
...
<tr>
<td>I use first aid, primarily. These wounds aren抰 going to wrap themselves.</td>
<td>
<div class="result-container ">
<div class="result" style="width: 27px; ">
<span>12%</span>
...
<tr>
<td>You抣l usually find me cooking in the kitchen. (ding) Order抯 up!</td>
<td>
<div class="result-container ">
...
<tr>
<td>I抳e missed out on all of the secondary professions, so far.</td>
<td>
<div class="result-container ">
												...
												<td colspan="2" class="report-submit">
													<div>
														<a href="javascript:;" onclick="Cms.Topic.reportSubmit('comments')">Submit</a>
														 |
														<a href="javascript:;" onclick="Cms.Topic.reportCancel()"><?php echo $Reg['Reg36']; ?></a>
													</div></td>
											</tr>
										</table>
														...
														<div class="content">
															...
															<div class="action">
																<div class="cancel">
																	...
																	<a href="javascript:;" onclick="$('#comment-form-reply').slideUp();"><?php echo $Reg['Reg36']; ?></a>
																</div>
													
																<div class="submit">
																	<button class="ui-button button1 comment-submit " type="submit">
																		<span>
																			<span><?php echo $Media['SendVideo']; ?></span>
																		</span>
																	</button>
																</div>
																<span class="clear"><!-- --></span>
                    ...
                    <!-- FORM POST TOP -->
                      ...
                      <form action="" method="" id="comment-form-reply" class="nested">
                        <table class="dynamic-center"><tr><td>
                          <a class="ui-button button1 " href="?login" onclick="return Login.open(\'loginframe.php\')"><span><span>回复</span></span></a>	
                        </td></tr></table>
                      </form>
											<table class="dynamic-center"><tr><td>
											<a class="ui-button button1 " href="?login" onclick="return Login.open(\'loginframe.php\')"><span><span>回复</span></span></a>
							...
							<div class="sidebar-module" id="sidebar-recent">
								<div class="sidebar-content">
									<div class="sidebar-title">
										<h3 class="title-recent"> <?php echo $Latest['Latest']; ?> </h3>
									</div>
									<div class="sidebar-content">
											<?php
											...
											<li>
												...
												<span class="image" style="background-image: url('news/<?php echo $articles['image']; ?>.jpg');"></span>
											       ...
											       <p> <span class="date"> <?php echo $Index['By']; ?> <?php echo $posterInfo['firstName']; ?></span></p>
												   <p><span class="date"><?php echo $articles['date']; ?></span></p>
												   <span class="clear"></span>
												</a>
												</li>
											</ul>
