...
<head>
<title><?php echo $website['title']; ?> - 账户设置</title>
...
<div id="content">
<div id="page-header">
<h2 class="subcategory">账号个人信息</h2>
<h3 class="headline">个人相关信息</h3>
</div>
<div id="page-content" class="page-content">
<p>这些是您首次注册时的默认帐户信息 <?php echo $website['title']; ?></p>
...
?>
加入: <?php echo $get["joindate"] ?>

</h4><br />
<h4>账户: </h4><font color='#66CE21'><?php echo strtolower($_SESSION['username']); ?>,</font>
<p></p>
<h4>邮箱:</h4>
<p><?php echo $get["email"] ?>,<p>
城市: <Font color="#A00000">Unavailable</font>, 
<p>最后登录IP: <Font color="#A00000"><?php echo $get["last_ip"] ?></font>,</p>
<p><h4>全名: <Font color="#A00000">Unavailable</font>,</h4></p>
<p>招募的队友: <Font color="#A00000"><?php echo $get["recruiter"] ?></font>.</p>
<p></p>
<div class="activate-primary">
<div id="primary-address">这是您的首选寄送地址。</div>
</div>
