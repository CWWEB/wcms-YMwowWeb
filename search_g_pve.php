          	...
          	<div class="search-left">
            	...
            	if (!$error){
            	 echo '<ul class="dynamic-menu" id="menu-search">
	              ...
	              if ($num_guild>0){ echo '<li class="item-active"><a href="search_g_pve.php?search='.$term.'"><span class="arrow">'.$guild['Guilds'].' ('.$num_guild.')'.'<span></span></span></a></li>';}
	...
	<!-- Here goes the pagination code. -->
              <div class="data-options ">
              	<div class="option">
                	...
                	<?php
                	if (!$error){
                  pagination($page,$num_pages,$term,'search_g_pve.php',$ChatB['ChatB5'],$search['prev']);}
                  ?>
                	</ul>
               	</div>
              	<?php 
