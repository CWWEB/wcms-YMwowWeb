...
<div class="info">
<h2 class="title">网站维护通知</h2>
<p class="short"><?php echo $website['title']; ?> 衣米魔兽官方网站正在维护升级中，请稍后再试。!</p>
<div class="twitter">相关更新详情, 请关注 <a tabindex="1" target="_blank" href="http://weibo.com/ymisc">@<?php echo $website['title']; ?></a> 新浪微博.
</div>
</div>
</div>
<div class="footer" id="en-us:footer"><center>
<small><?php echo $copyright3['copyright3']; ?>.<br /><?php echo $copyright['copyright'];  echo $website['title']; ?>.<br /><?php echo $copyright4['copyright4']; ?></small><a href="http://ymisc.com/" height="46" width="190">
