...
require_once('functions/armory_func_pve.php');     
$page_cat = "services";
include("classes/armory.class_pve.php");
...
<head>
<title><?php echo $website['title']; ?> - 【洛丹伦王国】英雄榜</title>
	...
	"unenchantedItems": {
        ...
        //]]>
						...
						<div id="summary-reforging" class="summary-reforging">
						    ...
						    <div class="profile-box-simple"><?php echo $armory['disable']; ?></div>
						</div>
					</div>
...
<div class="summary-stats-bottom">
	...
	<ul>
		<li class="rating"><span class="name"><?php echo $statNav['TopHonor']; ?></span><span class="value"><?php echo @$honor ?></span><span class="clear"><!-- --></span></li>
		<li class="kills"><span class="name"><?php echo $statNav['TopConquest']; ?></span><span class="value"><?php echo @$conq ?></span><span class="clear"><!-- --></span></li>
	</ul>
</div>
<div class="summary-professions">
	...
	<div class="profile-progress border-3" >
		...
		<span class="name"><?php echo $armory['zhuanye1']; ?></span>
	...
	<div class="profile-progress border-3" >
		...
		<span class="icon-frame frame-12 ">
			<img src="http://eu.media.blizzard.com/wow/icons/18/inv_pick_02.jpg" alt="" width="12" height="12" />
				...
				<span class="name"><?php echo $armory['zhuanye2']; ?></span>
							<span class="value">0</span>
							</a>
</div>
	</div>
	...
	<span class="clear"><!-- --></span>
	<span class="clear"><!-- --></span>
				<div class="summary-lastupdate"><?php echo $armory['updated']; ?> 09/08/2011</div>
			</div>
		</div>
	<span class="clear"><!-- --></span>
</div>
