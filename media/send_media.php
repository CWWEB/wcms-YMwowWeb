...
<table width="550" height="330">
    ...
    <td valign="top"><label><?php echo $Media['Description']; ?></label></td>
	  <td valign="top"><div align="right"><textarea type="text" name="description_form"  class="input border-5 glow-shadow-2 form-disabled" cols="38" rows="8" required ></textarea></div></td>
  </tr>
