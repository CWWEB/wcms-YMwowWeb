            ...
            $date = $videos['date']; 
				...
				<div class="content-bot">	
				  ...
				  ?> 
					...
					<iframe width="767" height="420" src="http://player.youku.com/embed/<?php echo $videos['id_url']; ?>" frameborder="0" allowfullscreen></iframe></td></tr>
          </table>
          </div>
          <table width="940">
            <tr><td width="40"></td><td width="860" height="40">发布者<a href="#"><?php echo $posterInfo['firstName']; ?></a><span> // </span><?php echo $videos['date']; ?></td><td width="40"></td></tr>
